...
{
    public const string NO_PRODUCTS_FOR_FILTERS = "There are no products matching your search and filter criteria.";
    ...
    public const string INVALID_PAGINATION_PARAMETERS = "The pagination query parameters are invalid.";
